<script lang="ts">
	...
	>
		<div class="modal-box flex flex-col items-center">
			...
			<div class="flex flex-col mt-5 items-center gap-3 w-full">
				<div role="tablist" class="tabs tabs-box">
					<a
						...
						class={['tab', active_tab == 'LOGIN' ? 'tab-active' : '']}
						>{i18next.t('account:login')}</a
					>
					<a
						role="tab"
			...
			<form
				class="flex flex-col items-center gap-3 w-full mt-5"
				onsubmit={async () =>
					active_tab == 'LOGIN'
			...
			>
				...
				<fieldset class="fieldset">
					...
					<input
						...
						class={[
							'input',
							invalid_credentials || email_in_use || other_error
								? 'input-error'
								: active_tab == 'REGISTER'
									? 'validator'
									: '',
