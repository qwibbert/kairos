...
function push_default(e) {
    ...
    if (!version || version != __KAIROS_VERSION__) {
        return e.json(426, ServerErrorFactory.version("vines.push", e.requestInfo().body.id, {
         ...
         */ new Date(real_master_state.get("updated_at")).toISOString().replace("T", " ") !== change_row.assumedMasterState.updated_at) {
                    ...
                    try {
                        ...
                        if (err.toString() == "GoError: parent: Failed to find all relation records with the provided ids.") {
                            ...
                            return e.json(424, VinesSyncErrorFactory.parent_rel("vines.push", (_change_row_newDocumentState_id = (_change_row_newDocumentState5 = change_row.newDocumentState) === null || _change_row_newDocumentState5 === void 0 ? void 0 : _change_row_newDocumentState5.id) !== null && _change_row_newDocumentState_id !== void 0 ? _change_row_newDocumentState_id : "???", {
                                parent_id: (_change_row_newDocumentState_id1 = (_change_row_newDocumentState6 = change_row.newDocumentState) === null || _change_row_newDocumentState6 === void 0 ? void 0 : _change_row_newDocumentState6.id) !== null && _change_row_newDocumentState_id1 !== void 0 ? _change_row_newDocumentState_id1 : "???"
                            }));
                        } else if (err.toString() == "GoError: course: Failed to find all relation records with the provided ids.") {
                            var _change_row_newDocumentState7, _change_row_newDocumentState8;
                            var _change_row_newDocumentState_id2, _change_row_newDocumentState_id3;
                            return e.json(424, VinesSyncErrorFactory.course_rel("vines.push", (_change_row_newDocumentState_id2 = (_change_row_newDocumentState7 = change_row.newDocumentState) === null || _change_row_newDocumentState7 === void 0 ? void 0 : _change_row_newDocumentState7.id) !== null && _change_row_newDocumentState_id2 !== void 0 ? _change_row_newDocumentState_id2 : "???", {
                                course: (_change_row_newDocumentState_id3 = (_change_row_newDocumentState8 = change_row.newDocumentState) === null || _change_row_newDocumentState8 === void 0 ? void 0 : _change_row_newDocumentState8.id) !== null && _change_row_newDocumentState_id3 !== void 0 ? _change_row_newDocumentState_id3 : "???"
                            }));
                        } else {
                            var _change_row_newDocumentState9;
                            var _change_row_newDocumentState_id4;
                            return e.json(500, VinesSyncErrorFactory.other("vines.push", (_change_row_newDocumentState_id4 = (_change_row_newDocumentState9 = change_row.newDocumentState) === null || _change_row_newDocumentState9 === void 0 ? void 0 : _change_row_newDocumentState9.id) !== null && _change_row_newDocumentState_id4 !== void 0 ? _change_row_newDocumentState_id4 : "???", {
                                original: err
                            }));
                        }
                    }
