...
// src/entries/vines/vines-pull.ts
var vines_pull_exports = {};
__export(vines_pull_exports, {
    default: function() {
        return vines_pull_default;
    }
});
module.exports = __toCommonJS(vines_pull_exports);
var import_rxdb = require("rxdb");
function vines_pull_default(e) {
    var _e_auth, _this, _this1;
    var body = e.requestInfo().body;
    var id = body.id;
    var updated_at = parseFloat(body.updated_at);
    var documents = arrayOf(new Record());
    $app.db().select("*").from("vines").where($dbx.exp("user = {:user}", {
