...
// src/entries/sessions/errors.ts
var history_sync_error_map2 = /* @__PURE__ */ new Map([
    [
    ...
    _create_class(HistorySyncErrorFactory, null, [
        {
            ...
            value: function parent_rel(operation, entity_id, additional_data) {
                return new HistorySyncError({
                    ...
                    message: "".concat(history_sync_error_map2.get("PARENT_REL" /* PARENT_REL */ )),
                    context: {
                        operation: operation,
                        entity_id: entity_id,
                        timestamp: /* @__PURE__ */ new Date(),
        ...
        },
        {
            ...
            value: function course_rel(operation, entity_id, additional_data) {
                return new HistorySyncError({
                    ...
                    message: "".concat(history_sync_error_map2.get("COURSE_REL" /* COURSE_REL */ )),
                    context: {
                        operation: operation,
                        entity_id: entity_id,
                        timestamp: /* @__PURE__ */ new Date(),
        ...
        },
        {
            ...
            value: function other(operation, entity_id, additional_data) {
                return new HistorySyncError({
                    name: "OTHER" /* OTHER */ ,
                    message: "".concat(history_sync_error_map2.get("OTHER" /* OTHER */ )),
                    context: {
                        operation: operation,
                        entity_id: entity_id,
                        timestamp: /* @__PURE__ */ new Date(),
...
function push_default(e) {
    ...
    if (!version || version != __KAIROS_VERSION__) {
        return e.json(426, ServerErrorFactory.version("session.pull", e.requestInfo().body.id, {
    ...
    $app.runInTransaction(function(tx) {
        ...
        try {
            for(var _iterator = change_rows[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                ...
                var sessions_collection = tx.findCollectionByNameOrId("sessions");
                var real_master_state = null;
                var new_record = false;
                try {
                    var _e_auth, _change_row_newDocumentState;
                    real_master_state = tx.findFirstRecordByFilter(sessions_collection, "user = {:user} && id = {:id}", {
                    ...
                    if (err.toString() == "GoError: sql: no rows in result set") {
                        real_master_state = new Record(sessions_collection, {
                            id: $security.randomStringByRegex("[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}"),
                            created_at: /* @__PURE__ */ new Date().toISOString().replace("T", " "),
                            updated_at: /* @__PURE__ */ new Date().toISOString().replace("T", " ")
                        });
                        new_record = true;
                    }
                }
         ...
         */ new Date(real_master_state.get("updated_at")).toISOString().replace("T", " ") !== change_row.assumedMasterState.updated_at) {
                        var copy = real_master_state.fieldsData();
                        ...
                        try {
                            ...
                            real_master_state.load(_object_spread_props(_object_spread({}, change_row.newDocumentState), {
                                ...
                                vine: change_row.newDocumentState.vine_id,
                                vine_course: change_row.newDocumentState.vine_course
                            }));
                    ...
                    var _change_row_newDocumentState2;
                    try {
                        var _e_auth2;
                        real_master_state.load(_object_spread_props(_object_spread({}, change_row.newDocumentState), {
                        ...
                        if (err.toString() == "GoError: vine: Failed to find all relation records with the provided ids.") {
                            var _change_row_newDocumentState3, _change_row_newDocumentState4;
                            var _change_row_newDocumentState_id, _change_row_newDocumentState_id1;
                            return e.json(424, HistorySyncErrorFactory.parent_rel("sessions.push", (_change_row_newDocumentState_id = (_change_row_newDocumentState3 = change_row.newDocumentState) === null || _change_row_newDocumentState3 === void 0 ? void 0 : _change_row_newDocumentState3.id) !== null && _change_row_newDocumentState_id !== void 0 ? _change_row_newDocumentState_id : "???", {
                                parent_id: (_change_row_newDocumentState_id1 = (_change_row_newDocumentState4 = change_row.newDocumentState) === null || _change_row_newDocumentState4 === void 0 ? void 0 : _change_row_newDocumentState4.id) !== null && _change_row_newDocumentState_id1 !== void 0 ? _change_row_newDocumentState_id1 : "???"
                            }));
                        } else if (err.toString() == "GoError: vine_course: Failed to find all relation records with the provided ids.") {
                            var _change_row_newDocumentState5, _change_row_newDocumentState6;
                            var _change_row_newDocumentState_id2, _change_row_newDocumentState_id3;
                            return e.json(424, HistorySyncErrorFactory.course_rel("sessions.push", (_change_row_newDocumentState_id2 = (_change_row_newDocumentState5 = change_row.newDocumentState) === null || _change_row_newDocumentState5 === void 0 ? void 0 : _change_row_newDocumentState5.id) !== null && _change_row_newDocumentState_id2 !== void 0 ? _change_row_newDocumentState_id2 : "???", {
                                course: (_change_row_newDocumentState_id3 = (_change_row_newDocumentState6 = change_row.newDocumentState) === null || _change_row_newDocumentState6 === void 0 ? void 0 : _change_row_newDocumentState6.id) !== null && _change_row_newDocumentState_id3 !== void 0 ? _change_row_newDocumentState_id3 : "???"
                            }));
                        } else {
                            var _change_row_newDocumentState7;
                            var _change_row_newDocumentState_id4;
                            return e.json(500, HistorySyncErrorFactory.other("sessions.push", (_change_row_newDocumentState_id4 = (_change_row_newDocumentState7 = change_row.newDocumentState) === null || _change_row_newDocumentState7 === void 0 ? void 0 : _change_row_newDocumentState7.id) !== null && _change_row_newDocumentState_id4 !== void 0 ? _change_row_newDocumentState_id4 : "???", {
                                original: err
                            }));
                        }
                    }
                    event.documents.push(change_row.newDocumentState);
                    event.checkpoint = {
                        id: (_change_row_newDocumentState2 = change_row.newDocumentState) === null || _change_row_newDocumentState2 === void 0 ? void 0 : _change_row_newDocumentState2.id,
                        updated_at: change_row.newDocumentState.updated_at
                    };
                }
            }
        ...
        if (event.documents.length > 0) {
            ...
            var message = new SubscriptionMessage({
                name: ((_e_auth3 = e.auth) === null || _e_auth3 === void 0 ? void 0 : _e_auth3.id) + "_sessions",
                data: JSON.stringify({
                    event: event
                })
            });
            ...
            for(var clientId in clients){
                var _e_auth4;
                if (clients[clientId].hasSubscription(((_e_auth4 = e.auth) === null || _e_auth4 === void 0 ? void 0 : _e_auth4.id) + "_sessions")) {
