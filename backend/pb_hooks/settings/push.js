...
function push_default(e) {
    ...
    if (!version || version != __KAIROS_VERSION__) {
        return e.json(426, ServerErrorFactory.version("settings.push", e.requestInfo().body.id, {
    ...
    $app.runInTransaction(function(tx) {
        ...
        try {
            for(var _iterator = change_rows[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                ...
                var settings_collection = tx.findCollectionByNameOrId("settings");
                var real_master_state = null;
                var new_record = false;
                try {
                    var _e_auth;
                    real_master_state = tx.findFirstRecordByFilter(settings_collection, "user = {:user}", {
                        user: (_e_auth = e.auth) === null || _e_auth === void 0 ? void 0 : _e_auth.id
                    });
                } catch (err) {
                    if (err.toString() == "GoError: sql: no rows in result set") {
                        real_master_state = new Record(settings_collection, {
         ...
         */ new Date(real_master_state.get("updated_at")).toISOString().replace("T", " ") !== change_row.assumedMasterState.updated_at) {
                        ...
                        real_master_state.load(_object_spread_props(_object_spread({}, change_row.newDocumentState), {
                            id: real_master_state === null || real_master_state === void 0 ? void 0 : real_master_state.id,
        ...
        if (event.documents.length > 0) {
            ...
            var message = new SubscriptionMessage({
                name: ((_e_auth3 = e.auth) === null || _e_auth3 === void 0 ? void 0 : _e_auth3.id) + "_settings",
                data: JSON.stringify({
                    event: event
                })
            });
            ...
            for(var clientId in clients){
                var _e_auth4;
                if (clients[clientId].hasSubscription(((_e_auth4 = e.auth) === null || _e_auth4 === void 0 ? void 0 : _e_auth4.id) + "_settings")) {
